...
-- Verification query
COMMENT ON TABLE public.admissions IS 'Stores course admission registrations for NITT vocational institute';
COMMENT ON TABLE public.contact_messages IS 'Stores general inquiries submitted through NITT contact page';
