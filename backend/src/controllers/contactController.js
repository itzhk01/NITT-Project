...
const submitContactMessage = async (req, res) => {
  try {
    ...
    if (isConfigured && supabase) {
      ...
      return res.status(201).json({
        success: true,
        message: 'Thank you for contacting NITT. Your message has been stored in our system and an advisor will reply shortly.',
    ...
    return res.status(201).json({
      success: true,
      message: 'Thank you for contacting NITT. Your message has been received and our team will get in touch shortly.',
      data: messageData,
