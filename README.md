...
A professional, corporate-style web application for the **National Institute of Technical Training (NITT)**, a vocational training institute specializing in computer-based career courses.
...
- Generates a unique tracking reference number (e.g. `NITT-2026-XXXX`).
