...
document.addEventListener("DOMContentLoaded", function () {
  ...
  widget.innerHTML = `
    <button id="nitt-chatbot-toggle" aria-label="Open chat">💬</button>
    <div id="nitt-chatbot-window">
      <div id="nitt-chatbot-header">
        <span>NITT Help Desk</span>
        <button id="nitt-chatbot-close" aria-label="Close chat">&times;</button>
      </div>
      <div id="nitt-chatbot-body"></div>
      <div id="nitt-chatbot-options"></div>
    </div>
  `;
  document.body.appendChild(widget);

  const toggleBtn = document.getElementById("nitt-chatbot-toggle");
  const closeBtn = document.getElementById("nitt-chatbot-close");
  const chatWindow = document.getElementById("nitt-chatbot-window");
  const chatBody = document.getElementById("nitt-chatbot-body");
  const chatOptions = document.getElementById("nitt-chatbot-options");

  function addMessage(text, sender) {
    const msg = document.createElement("div");
    msg.className = "nitt-chat-msg " + sender;
  ...
  function showQuestionList() {
    ...
    nittFaqData.forEach(function (item) {
      const btn = document.createElement("button");
      btn.className = "nitt-option-btn";
  ...
  function startChat() {
    chatBody.innerHTML = "";
    addMessage("Hi! 👋 I'm the NITT Help Desk bot. Pick a question below and I'll answer instantly.", "bot");
    showQuestionList();
  }
