/**
 * National Institute of Technical Training (NITT)
...
const COURSES_DATA = [
  ...
  },
  {
    ...
    certificationBadge: "NITT Vocational Diploma"
  },
  {
    id: "msoffice",
  ...
  },
  {
    ...
    certificationBadge: "NITT Certified Python Associate"
  },
  {
    id: "dtp",
  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        outcome: "Deliver an end-to-end office automation system portfolio certified by NITT faculty."
      }
    ]
  },
  {
...
const TESTIMONIALS_DATA = [
  {
    ...
    quote: "Joining NITT transformed my career outlook completely. The 1:1 computer lab practice and teacher attention gave me the confidence to handle corporate spreadsheets and administrative paperwork without any hesitation.",
    rating: 5
  },
  {
    name: "Pooja Verma",
  ...
  },
  {
    ...
    quote: "I had no coding background, but the faculty at NITT started from the absolute basics of HTML and CSS. Within 4 months, I built 3 live portfolio projects and landed my first web design job.",
    rating: 5
  },
  {
...
const FAQ_DATA = [
  ...
  },
  {
    ...
    answer: "Yes, NITT offers interest-free monthly installment facilities for all diploma and multi-month programs. An initial registration fee is paid upon admission, and the balance can be split into comfortable monthly installments."
  },
  {
    category: "Certification",
    question: "Is the certificate issued by NITT recognized by employers?",
    answer: "Yes. National Institute of Technical Training (NITT) is an ISO 9001:2015 certified vocational education institute. Certificates and diplomas carry a unique registration number with a tamper-proof QR code that can be verified online by recruiters, government portals, and corporate employers."
  },
  {
    category: "Certification",
  ...
  {
    category: "Placement",
    question: "Does NITT provide placement assistance after course completion?",
